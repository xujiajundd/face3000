...
public:
    ...
    struct feature_node* GetGlobalBinaryFeatures(cv::Mat_<cv::Vec3b>& image, cv::Mat_<float>& current_shape, BoundingBox& bbox, cv::Mat_<float>& rotation, float scale, float& score, bool& is_face);
    struct feature_node* NegMineGetGlobalBinaryFeatures(cv::Mat_<cv::Vec3b>& image, cv::Mat_<float>& current_shape, BoundingBox& bbox, cv::Mat_<float>& rotation, float scale, float& score, bool& is_face, int stage, int currentStage, int landmark, int tree, bool& stop);
...
public:
	...
	cv::Mat_<float> Predict(cv::Mat_<cv::Vec3b>& image, cv::Mat_<float>& current_shape, BoundingBox& bbox, bool &is_face, float &score);
    cv::Mat_<float> NegMinePredict(cv::Mat_<cv::Vec3b>& image,
